...
SELECT*
FROM vendor
INNER JOIN vendor_booth_assignments ON vendor.vendor_id
...
SELECT vendor_owner_last_name, vendor_owner_first_name,
    SUM(customer_purchases.quantity * customer_purchases.cost_to_customer_per_qty) AS total_spent
FROM vendor
INNER JOIN customer_purchases ON vendor.vendor_id
HAVING total_spent > 2000
ORDER BY vendor_owner_last_name, vendor_owner_first_name;
